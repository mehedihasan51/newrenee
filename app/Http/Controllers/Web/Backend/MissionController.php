...
class MissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("backend.layouts.mission.index");
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Mission::create($validate);

            session()->put('t-success', 'Mission created successfully');
        } catch (Exception $e) {
    ...
    public function show($id)
    {
        ...
        $mission->image_url = asset('/' . $mission->image);
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                if ($mission->image && file_exists(public_path($mission->image))) {
                    Helper::fileDelete(public_path($mission->image));
                }
                $validate['image'] = Helper::fileUpload($request->file('image'), 'image', time() . '_' . getFileName($request->file('image')));
            }

            $mission->update($validate);
            session()->put('t-success', 'Mission updated successfully');
        } catch (Exception $e) {
            session()->put('t-error', $e->getMessage());
        }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'Error deleting mission: ' . $e->getMessage()
            ]);
        }
    }
