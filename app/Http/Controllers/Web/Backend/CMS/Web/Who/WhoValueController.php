...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Who;
...
class WhoValueController extends Controller
{
    protected $cmsService;
    
    public $name = "who";
    public $section = "value";
    public $page = PageEnum::WHO;
    public $item = SectionEnum::WHO_VALUE_SECTION;
    public $items = SectionEnum::WHO_VALUE_SECTIONS;
    public $count = 4;
