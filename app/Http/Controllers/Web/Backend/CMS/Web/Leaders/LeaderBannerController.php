...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Leaders;
...
class LeaderBannerController extends Controller
{
    protected $cmsService;

    public $name = "leader";
    public $section = "banner";
    public $page = PageEnum::LEADERS;
    public $item = SectionEnum::LEADER_BANNER;
    public $items = SectionEnum::LEADER_BANNERS;
    public $count = 4;
