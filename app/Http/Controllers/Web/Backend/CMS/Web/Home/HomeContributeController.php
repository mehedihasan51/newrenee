...
class HomeContributeController extends Controller
{
    protected $cmsService;
    
    public $name = "home";
    public $section = "contribute";
    public $page = PageEnum::HOME;
    public $item = SectionEnum::CONTRIBUTE_SECTION;
    public $items = SectionEnum::CONTRIBUTE_SECTIONS;
    public $count = 4;
