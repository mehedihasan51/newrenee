...
namespace App\Http\Controllers\Web\Backend\CMS\Web\LeaderDetails;
...
class LeaderDetailsBannerController extends Controller
{
    protected $cmsService;

    public $name = "leader_details";
    public $section = "banner";
    public $page = PageEnum::LEADERS_DETAILS;
    public $item = SectionEnum::LEADER_DETAILS_BANNER;
    public $items = SectionEnum::LEADER_DETAILS_BANNERS;
    public $count = 4;
