...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Policies;
...
class PolicieBannerController extends Controller
{
    protected $cmsService;

    public $name = "policies";
    public $section = "banner";
    public $page = PageEnum::POLICIES;
    public $item = SectionEnum::POLICIES_BANNER;
    public $items = SectionEnum::POLICIES_BANNERS;
    public $count = 4;
