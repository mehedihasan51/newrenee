        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Member Section</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Member Section</a></li>
                                    ...
                                    <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0">Representative Button</th>
                                                <th class="bg-transparent border-bottom-0">Senator Button</th>
...
@push('scripts')
    ...
    <script>
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'representative_button',
                            name: 'representative_button',
                            orderable: true,
                            searchable: true
                        },
                        {
        ...
        function statusChange(id) {
            NProgress.start();
            let url = "{{ route('admin.member.status', ':id') }}";
            $.ajax({
                type: "GET",
