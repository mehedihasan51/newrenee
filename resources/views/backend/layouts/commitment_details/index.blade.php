                        ...
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                ...
                                <div class="card-options ms-auto">
                                    <a href="{{ route('admin.commitment_detail.create') }}"
                                    ...
                                    <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0 wp-15">Commitment Details Title
                                                </th>
                                                <th class="bg-transparent border-bottom-0 wp-15">Commitment Title</th>
...
@push('scripts')
    ...
    <script>
        function viewModalContent(id) {
            fetch(`/admin/commitment_detail/show/${id}`)
                .then(response => {
                    if (!response.ok) {
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.commitment_detail.index') }}",
                        type: "GET",
                    },
        ...
        function statusChange(id) {
            NProgress.start();
            let url = "{{ route('admin.commitment_detail.status', ':id') }}";
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('admin.commitment_detail.destroy', ':id') }}";
