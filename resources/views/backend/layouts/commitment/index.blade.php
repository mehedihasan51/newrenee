@extends('backend.app', ['title' => 'Commitment Category'])
                        ...
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                ...
                                <div class="card-options ms-auto">
                                    <a href="{{ route('admin.commitment.create') }}" class="btn btn-primary btn-sm">Add</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.commitment.index') }}",
                        type: "GET",
                    },
        ...
        function statusChange(id) {
            NProgress.start();
            let url = "{{ route('admin.commitment.status', ':id') }}";
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('admin.commitment.destroy', ':id') }}";
        ...
        function goToEdit(id) {
            let url = "{{ route('admin.commitment.edit', ':id') }}";
