        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.home.customer.index') }}" class="slide-item">Customer Section</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.home.about.index') }}" class="slide-item">About Section</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.home.contribute.index') }}" class="slide-item">Contribute Section</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.who.value.index') }}" class="slide-item">Who Value Section</a></li>
                    </ul>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Faq Page</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.faq.section.index') }}" class="slide-item">Faq Section</a></li>
                    </ul>
